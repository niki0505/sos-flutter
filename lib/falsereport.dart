...
class FalseReportPage extends StatefulWidget {
  ...
  const FalseReportPage({super.key, required this.sosID});
                            ...
                            if (_actionController.text.isEmpty) {
                              ...
                              final confirm = await showDialog<bool>(
                                ...
                                builder: (context) => AlertDialog(
                                  title: const Text("Confirm False Alarm"),
                                  content: const Text(
                                    "Are you sure you want to mark this report as false alarm?",
                                  ),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                              ...
                              if (confirm == true) {
                                await fireStoreService.falseAlarmSOS(
                                  widget.sosID,
